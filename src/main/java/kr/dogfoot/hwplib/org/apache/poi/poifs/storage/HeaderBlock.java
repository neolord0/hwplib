...
import kr.dogfoot.hwplib.org.apache.poi.poifs.filesystem.FileMagic;
import kr.dogfoot.hwplib.org.apache.poi.poifs.filesystem.NotOLE2FileException;
import kr.dogfoot.hwplib.org.apache.poi.poifs.filesystem.OfficeXmlFileException;
import kr.dogfoot.hwplib.org.apache.poi.util.HexDump;
...
public final class HeaderBlock implements HeaderBlockConstants {
	...
	private HeaderBlock(byte[] data) throws IOException {
       ...
       case BIFF3:
       case BIFF4:
           throw new IOException("The supplied data appears to be in "+fm+" format. "
