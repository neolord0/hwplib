...
import kr.dogfoot.hwplib.org.apache.poi.hpsf.wellknown.SectionIDMap;
...
public class PropertySet
{
    ...
    private static final String DocumentSummaryInformation_ID = "{9FA2B660-1061-11D4-B4C6-006097C09D8C}";
    /**
    ...
    public boolean isSummaryInformation()
    {
        if (sections.size() <= 0)
            return false;
        return DocumentSummaryInformation_ID.equals(sections.get(0).getFormatID().toString());
    }
