...
public class Inserting_Image_Cell {
    public static void main(String[] args) throws Exception {

        String docFilePath = "sample_hwp" + File.separator + "inserting_image_cell.hwp";
        String docResultFilePath = "sample_hwp" + File.separator + "result_inserting_image_cell.hwp";
        String imgFilePath = "sample_hwp" + File.separator + "image" + File.separator + "sample.jpg";
        ...
        if (hwpFile != null) {
            ...
            System.out.println("============================================================");
            HWPWriter.toFile(hwpFile, docResultFilePath);
        }
    }
    ...
    public static void IMPL_InsertPicture(HWPFile hwpFile, String fieldName, String imgFilePath) throws IOException {
        ...
        Inserting_Image_Cell tii = new Inserting_Image_Cell();
